  ...
  readingSteps: [
    {
      ...
      body: `Use row first, column second. ${bEntry(2, 1)} is the impact response of S&amp;P 500 growth to the policy shock. Negative or zero passes the Atlas rule; positive violates it. No magnitude target is imposed.`,
    },
    {
      title: '2. Read zero loss as membership',
      body: 'On the objective plot, every angle on a zero plateau belongs to the accepted set. A lower value does not identify one rotation within that plateau, and the length of the plateau is not a p-value or specification test.',
    },
    {
      title: '3. Inspect what remains unidentified',
      body: 'Switch to accepted rotations and compare complete IRF paths. If they tell different stories after impact, that variation is exactly what the one-sign restriction has not identified. A single representative path would require an additional, declared summary or selection rule.',
    },
  ],
  ...
  literatureSections: [
    {
      ...
      body: 'Faust (1998, Abstract) evaluates robustness by searching all identifications for the one most adverse to a VAR conclusion, subject to qualitative impulse-response restrictions. Canova and De Nicol&oacute; (2002, Abstract and Section 3) assign economic labels to orthogonal innovations using signs of dynamic cross-correlations. Uhlig (2005, Abstract and Section 2) identifies contractionary monetary-policy shocks by requiring prices and nonborrowed reserves not to rise and the federal funds rate not to fall for a chosen horizon, while leaving real GDP unrestricted.',
    },
    {
      title: 'Major variants and applications',
      body: 'Mountford and Uhlig (2009, Summary and Section 1) identify government-revenue and government-spending shocks with sign restrictions while controlling for business-cycle and monetary-policy shocks and allowing announcement effects. Kilian and Murphy (2012, Abstract and Sections 3.3&ndash;3.5) show that impact signs alone leave mutually contradictory oil-market models and narrow the set with bounds on the short-run oil-supply elasticity and the impact response of real activity. Antol&iacute;n-D&iacute;az and Rubio-Ram&iacute;rez (2018, Abstract and Section II) introduce narrative sign restrictions on recovered shocks and historical-decomposition contributions around dated events. Braun and Br&uuml;ggemann (2023, Abstract and Sections 2.2&ndash;2.3) combine sign restrictions with valid or plausibly exogenous external instruments, using inequalities when exact exogeneity is relaxed.',
    },
    {
      title: 'Rotation sampling, inference, and reporting',
      body: 'Rubio-Ram&iacute;rez, Waggoner, and Zha (2010, Theorem 9 and Algorithm 2) generate Haar-uniform orthogonal matrices by applying a QR decomposition to a standard-normal matrix, normalizing the diagonal of the triangular factor, and retaining rotations that satisfy the signs. Arias, Rubio-Ram&iacute;rez, and Waggoner (2018, Sections 3.5&ndash;3.6) draw rotations conditional on exact zero restrictions before filtering by signs because the equality-restricted set has measure zero among unrestricted draws. Kilian and L&uuml;tkepohl (2017, Chapter 13, Section 13.6.3) show that pointwise posterior median responses generally need not correspond to any one admissible structural model.',
    },
    {
      title: 'What the Atlas omits and the main critiques',
      body: 'The Atlas holds the reduced form fixed and applies one weak impact inequality, so it is deliberately simpler than the methods above. Its acceptance rate reports how much of this finite rotation grid survives; it is not a specification test. When an application selects one representative model, that choice should be stated separately from the restrictions that define admissibility. Reports should keep complete feasible response paths together and distinguish reduced-form uncertainty from variation across admissible rotations.',
    },
  ],
  literatureQuestions: [
